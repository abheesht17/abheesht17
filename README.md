...
I am a member of the [Keras](https://keras.io/) team at [Google](https://about.google/). I am a maintainer of [KerasRS](https://github.com/keras-team/keras-rs), a RecSys library built using Keras 3, and [KerasHub](https://github.com/keras-team/keras-hub), a pretrained modelling library. I love contributing to open source and have been contributing extensively to [KerasHub](https://github.com/keras-team/keras-hub) from before my time at Google. Previously, I was an Applied Scientist at [Amazon Science](https://www.amazon.science/), where my work involved devising Machine Learning techniques to detect advertisement bots. I've also dabbled in some [research](https://scholar.google.com/citations?user=gSLkLTMAAAAJ).
